    ...
    <div class="login-box">
      <el-form
        ...
        <el-form-item prop="code">
          <el-input v-model="loginForm.code" autocomplete="off" placeholder="点击图片更换验证码" style="width: 238px;margin-right: 10px">
            <i slot="prefix" class="fa fa-code el-input__icon"></i>
          </el-input>
          <el-image  :src="codeUrl" @click="upVerifyCode"></el-image>
        </el-form-item>
        <el-form-item>
          <el-button class="btn" type="primary" @click="submitLogin">登录</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    upVerifyCode() {
      this.codeUrl = '/code?time='+ new Date();
    },
    submitLogin() {
